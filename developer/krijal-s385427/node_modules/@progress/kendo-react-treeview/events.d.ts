 ...
 */
export interface TreeViewExpandChangeEvent extends BaseEvent<TreeViewHandle> {
    /**
 ...
 */
export interface TreeViewItemClickEvent extends BaseEvent<TreeViewHandle> {
    /**
 ...
 */
export interface TreeViewCheckChangeEvent extends BaseEvent<TreeViewHandle> {
    /**
 ...
 */
export interface TreeViewContextMenuEvent extends BaseEvent<TreeViewHandle> {
    /**
     * An event target.
     */
    target: TreeViewHandle;
    /**
