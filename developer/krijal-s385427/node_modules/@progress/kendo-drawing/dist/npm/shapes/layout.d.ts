...
export class Layout extends Group {
  ...
  /** @hidden */
  _initGroups(): { groups: { size: number }[]; groupsSize: number };

  /** @hidden */
  currentTransform(transformation?: geometry.Transformation | null): geometry.Transformation | null;

  /** @hidden */
  _fieldMap: { [key: string]: string };
