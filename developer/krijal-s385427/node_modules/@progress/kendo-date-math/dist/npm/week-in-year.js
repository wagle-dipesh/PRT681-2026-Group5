...
var moveDateToWeekStart = function (date, weekStartDay) {
    if (weekStartDay !== day_enum_1.Day.Monday) {
        return (0, add_days_1.addDays)((0, prev_day_of_week_1.prevDayOfWeek)(date, weekStartDay), 4);
    }
    return (0, add_days_1.addDays)(date, (4 - (date.getDay() || 7)));
};
var calcWeekInYear = function (date, weekStartDay) {
    var firstWeekInYear = (0, create_date_1.createDate)(date.getFullYear(), 0, 1, -6);
...
var weekInYear = function (date, weekStartDay) {
    ...
    date = (0, get_date_1.getDate)(date);
    var prevWeekDate = (0, add_days_1.addDays)(date, -7);
    var nextWeekDate = (0, add_days_1.addDays)(date, 7);
