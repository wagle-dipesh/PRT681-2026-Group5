...
var normalize = function (date, expectedMonth) { return (date.getMonth() !== expectedMonth ? (0, last_day_of_month_1.lastDayOfMonth)((0, exports.addMonths)(date, -1)) : date //tslint:disable-line:no-use-before-declare
); };
/**
...
var addMonths = function (date, offset) {
    ...
    return normalize((0, adjust_dst_1.adjustDST)(newDate, date.getHours()), expectedMonth);
};
