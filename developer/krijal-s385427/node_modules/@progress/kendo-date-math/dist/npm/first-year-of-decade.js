...
exports.firstYearOfDecade = void 0;
 ...
 * ```
 */
var firstYearOfDecade = function (value) { return ((0, normalize_year_1.normalizeYear)(value, function (y) { return y - (y % 10); })); };
exports.firstYearOfDecade = firstYearOfDecade;
