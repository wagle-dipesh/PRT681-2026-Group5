...
exports.lastDecadeOfCentury = void 0;
 ...
 * ```
 */
var lastDecadeOfCentury = function (value) { return ((0, normalize_year_1.normalizeYear)(value, function (y) { return y - (y % 100) + 90; })); };
exports.lastDecadeOfCentury = lastDecadeOfCentury;
