...
var lastDayOfMonth = function (date) {
    var newDate = (0, create_date_1.createDate)(date.getFullYear(), date.getMonth() + 1, 1, date.getHours(), date.getMinutes(), date.getSeconds(), date.getMilliseconds());
    return (0, add_days_1.addDays)(newDate, -1);
};
