...
exports.firstDecadeOfCentury = void 0;
 ...
 * ```
 */
var firstDecadeOfCentury = function (value) { return ((0, normalize_year_1.normalizeYear)(value, function (y) { return y - (y % 100); })); };
exports.firstDecadeOfCentury = firstDecadeOfCentury;
