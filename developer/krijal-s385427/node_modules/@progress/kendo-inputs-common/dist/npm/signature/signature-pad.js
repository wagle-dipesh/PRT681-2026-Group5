...
var SignaturePad = /** @class */ (function () {
    ...
    SignaturePad.prototype.exportImage = function (options) {
        ...
        return (0, kendo_drawing_1.exportImage)(exportGroup, Object.assign({
            width: exportWidth,
            height: exportHeight
        }, options));
    };
    SignaturePad.prototype.resize = function () {
        ...
        if (previousSize && previousSize[0] === size[0] && previousSize[1] === size[1]) {
            return;
        }
    ...
    SignaturePad.prototype.initSurface = function () {
        ...
        this.size = this.getSize() || [DEFAULT_WIDTH, DEFAULT_HEIGHT];
        this.background = kendo_drawing_1.Path.fromRect(new Rect([0, 0], this.size), {
            fill: {
                color: this.options.backgroundColor
            }
    ...
    SignaturePad.prototype.initResizeObserver = function () {
        var _this = this;
    ...
    SignaturePad.prototype.onPointerMove = function (e) {
        ...
        var minTimeDelta = 1000 / (0, common_1.limitValue)(this.options.samplingRate, 1, 10000);
        ...
        var minDelta = 1 / (0, common_1.limitValue)(this.options.precision, 0.01, 100);
